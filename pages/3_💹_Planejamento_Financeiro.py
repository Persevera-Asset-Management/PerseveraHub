...
patrimonio_inicial = st.sidebar.number_input("Patrimônio Inicial (R$):", min_value=0, value=100000, step=10000, format=".0f")
horizonte_temporal = st.sidebar.number_input("Horizonte Temporal (anos):", min_value=1, value=10, step=1, format=".0f")
resgate_mensal = st.sidebar.number_input("Resgate Mensal (R$):", min_value=0, value=10000, step=1000, format=".0f")
aporte_mensal = st.sidebar.number_input("Aporte Mensal (R$):", min_value=0, value=10000, step=1000, format=".0f")
