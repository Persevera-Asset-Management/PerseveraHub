CHARTS_ESTRATEGIA = {
    ...
    "br_focus_selic": {
        "chart_config": {
            "columns": ["br_focus_selic_median_2026R6", "br_focus_selic_median_2026R7", "br_focus_selic_median_2026R8", "br_focus_selic_median_2027R1"],
            "names": ["R6 (set/26)", "R7 (nov/26)", "R8 (dez/26)", "R1 (jan/27)"],
            "chart_type": "line",
