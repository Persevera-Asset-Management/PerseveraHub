CHARTS_ESTRATEGIA = {
    ...
    "br_focus_selic": {
        "chart_config": {
            "columns": ["br_focus_selic_median_2026R5", "br_focus_selic_median_2026R6", "br_focus_selic_median_2026R7", "br_focus_selic_median_2026R8"],
            "names": ["R5 (ago/26)", "R6 (set/26)", "R7 (nov/26)", "R8 (dez/26)"],
            "chart_type": "line",
