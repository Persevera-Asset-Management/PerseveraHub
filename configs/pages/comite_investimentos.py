CHARTS_INVESTIMENTOS_BR = {
    # ============================================================
    # 1) CRESCIMENTO
    # PIB, IBC-Br, Indústria, Serviços, Varejo, Emprego, Imobiliário,
    # Sentimento, Setor Externo
    # ============================================================
    ...
    "br_exports_imports": {
        "chart_config": {
            ...
            "chart_type": "line",
            "title": "Exportações e Importações (T12M)",
            "y_axis_title": "US$",
        },
        "transformations": [
    ...
    "br_direct_investment_liabilities": {
        "chart_config": {
            ...
            "names": ["% do PIB", "Acumulado 12 meses"],
            "chart_type": "dual_axis_line_area",
            "title": "Investimentos Diretos no País (IDP) - Ingresso net",
            "y_axis_title": ("% do PIB", "Valor"),
        },
        "width": 6,
        "context": "Crescimento",
    ...
    "br_international_reserves_total": {
        "chart_config": {
            ...
            "chart_type": "line",
            "title": "Reservas Internacionais (Total)",
    ...
    # Imobiliário: ainda sem série de dados brasileira mapeada.
    # Adicionar aqui quando houver fonte (ex.: FipeZap, Abrainc, CBIC).
    ...
    "br_resultado_do_setor_publico": {
        ...
        "transformations": [
            {"type": "multiply", "column": "br_bcb_primary_result_12m_to_gdp", "scalar": -1},
            {"type": "multiply", "column": "br_bcb_nominal_result_12m_to_gdp", "scalar": -1},
            {"type": "multiply", "column": "br_bcb_interest_paid_12m_to_gdp", "scalar": -1}
        ],
        "width": 6,
        "context": "Fiscal",
        "group": "Fiscal",
    ...
    # Sem dados mapeados por enquanto.
    # Candidato natural: br_focus_selic (Focus - Reuniões Copom),
    # hoje em CHARTS_ESTRATEGIA / contexto "Renda Fixa".
    # ============================================================
    ...
    "br_bcb_new_operations": {
        "chart_config": {
            ...
            "names": ["PJ", "PF"],
            "chart_type": "line",
            "title": "Concessão de Crédito (T12M var. Anual %)",
            "y_axis_title": "Var. (%)",
        },
        "transformations": [{"type": "rolling_sum_plus_yearly_variation", "column": "br_bcb_new_operations_pj", "frequency": "MS", "window": 12}, {"type": "rolling_sum_plus_yearly_variation", "column": "br_bcb_new_operations_pf", "frequency": "MS", "window": 12}],
        "width": 6,
        "context": "Liquidez",
        "group": "Crédito",
    ...
    "br_bcb_new_operations_details": {
        ...
        "transformations": [{"type": "rolling_sum_plus_yearly_variation", "column": "br_bcb_nonearmarked_new_operations_pj", "frequency": "MS"}, {"type": "rolling_sum_plus_yearly_variation", "column": "br_bcb_earmarked_new_operations_pj", "frequency": "MS"}, {"type": "rolling_sum_plus_yearly_variation", "column": "br_bcb_nonearmarked_new_operations_pf", "frequency": "MS"}, {"type": "rolling_sum_plus_yearly_variation", "column": "br_bcb_earmarked_new_operations_pf", "frequency": "MS"}],
        "width": 6,
        "context": "Liquidez",
        "group": "Crédito",
        "block_title": "Concessão de Crédito"
    ...
    "br_bcb_sfn_loans": {
        ...
        "transformations": [
            {"type": "yearly_variation", "column": "br_bcb_sfn_loans_to_government", "frequency": "MS"},
            {"type": "yearly_variation", "column": "br_bcb_sfn_loans_to_companies", "frequency": "MS"},
            {"type": "yearly_variation", "column": "br_bcb_sfn_loans_to_individuals", "frequency": "MS"}
        ],
        "width": 6,
        "context": "Liquidez",
        "group": "Crédito",
...
CHARTS_INVESTIMENTOS_US = {
    # ============================================================
    # 1) CRESCIMENTO
    # PIB, IBC-Br (N/A p/ EUA), Indústria, Serviços (N/A dedicado),
    # Varejo, Emprego, Imobiliário, Sentimento, Setor Externo (N/A)
    # ============================================================
    ...
    # IBC-Br: não há indicador equivalente de atividade coincidente
    # mapeado para os EUA nesta base (o mais próximo seria um índice
    # de surpresa/atividade tipo Chicago Fed NAI, ainda não integrado).

    # Serviços: não há grupo dedicado para os EUA nesta base; a atividade
    # de serviços aparece hoje via ISM Services / S&P Services PMI,
    # incluídos dentro de "Sentimento" acima.

    # Setor Externo: sem série mapeada para os EUA nesta base ainda
    # (ex.: trade balance, current account, etc. não incluídos em
    # CHARTS_ECONOMIA para "Estados Unidos").
    ...
    # 4) POLÍTICA MONETÁRIA
    # Sem dados mapeados por enquanto.
    # Candidatos naturais (hoje em CHARTS_ESTRATEGIA, contexto "Renda
    # Fixa"): us_treasuries (curva de juros), us_steepness (inclinações),
    # us_breakeven (inflação implícita), us_inflation (TIPS).
    # ============================================================
    ...
    "us_sloos_net_pct_banks_tightening_cni": {
        "chart_config": {
            ...
            "chart_type": "area",
            "title": "% net de bancos que estão tornando os critérios de aprovação mais rigorosos",
            "y_axis_title": "%",
        },
        "width": 6,
        "context": "Liquidez",
    ...
    "us_sloos_net_pct_banks_loan_spreads": {
        "chart_config": {
            ...
            "names": ["Grandes e médias empresas", "Pequenas empresas"],
            "chart_type": "area",
            "title": "% net de bancos que estão aumentando as margens sobre seus custos de financiamento",
            "y_axis_title": "%",
        },
        "width": 6,
        "context": "Liquidez",
    ...
    "us_sloos_net_pct_banks_demand_cni": {
        "chart_config": {
            ...
            "names": ["Grandes e médias empresas", "Pequenas empresas"],
            "chart_type": "area",
            "title": "% net de bancos que estão relatando uma demanda mais forte para empréstimos comerciais e industriais",
            "y_axis_title": "%",
        },
        "width": 6,
        "context": "Liquidez",
